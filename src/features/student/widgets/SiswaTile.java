package features.student.widgets;
...
public class SiswaTile extends RoundedPanel {
    ...
    public void setSelected(boolean isSelected) {
        setBackground(isSelected ? Colors.BLUE_BACKGROUND_COLOR : Colors.CARD_COLOR);
        setBorder(new RoundedBorder(
                Constants.MEDIUM_BORDER_RADIUS,
                Constants.LIGHT_BORDER_INSETS,
                isSelected ? Colors.ACTIVE_BORDER_COLOR : Colors.BORDER_COLOR));
        tv_namaBarang.setForeground(isSelected ? Colors.ACTIVE_TEXT_COLOR : Colors.TEXT_COLOR);
    }

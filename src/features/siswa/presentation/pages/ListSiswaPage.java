        ...
        scrollPane.getVerticalScrollBar().addAdjustmentListener((e) -> {
            ...
            if (e.getValue() > loadingArea && !isLoading) {
                if (currentJenisKelaminValue.equals(Strings.SEMUA)) {
                    ...
                    repository.initListSiswaByJenisKelaminWithoutThumbnail(this,
                            keyword, maxResult, currentIndex);
                }
            }
        ...
        listJenisKelamin.forEach((jenisKelamin) -> {
            ...
            chip.addActionListener((ae) -> {
                ...
                if (jenisKelamin.equals(Strings.SEMUA)) {
                    repository.initListSiswaWithoutThumbnail(this, maxResult,
                            currentIndex);
                } else {
                    ...
                    repository.initListSiswaByJenisKelaminWithoutThumbnail(
                            this, keyword, maxResult, currentIndex);
                }
